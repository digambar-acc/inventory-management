...
- Critical assumptions made in the code
...
// ✅ Good - explains why this approach is needed
// Process items sequentially to avoid race conditions with shared state
items.forEach(item => processItem(item))
```

**Documentation Standards:**
- Add comments above complex filter logic explaining the business rules
- Document API endpoint behavior that differs from REST conventions
- Explain date handling quirks (e.g., "month filter doesn't apply to inventory")
- Note any Vue reactivity gotchas or computed property dependencies
- Document why certain patterns were chosen over alternatives
