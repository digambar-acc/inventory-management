export default {
  ...
  restocking: {
    title: '再入荷',
    subtitle: '予算と需要に基づいて再入荷注文を計画・送信',
    setBudget: '利用可能予算を設定',
    budgetInfo: '予算情報',
    ...
    noRecommendations: '推奨事項がありません。予算またはフィルターを調整してください。',
    refresh: '推奨事項を更新',
    orderSummary: '注文概要',
    totalItems: '合計品目',
    totalUnits: '合計数量',
    ...
    add: '注文に追加',
    remove: '注文から削除',
    noItemsSelected: '品目が選択されていません。注文に品目を追加してください。',
    budgetExceeded: '予算超過！品目を削除するか予算を増やしてください。'
  },
